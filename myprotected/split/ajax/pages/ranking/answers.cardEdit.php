<?php 
	...
	$cardTmp = array(
		...
		'Annuity | Question'	=>	array( 'type'=>'select', 	'field'=>'question_id', 			'params'=>array( 'list'=>$questions, 
			'fieldValue'=>'id', 
			'fieldTitle'=>'question', 
			'currValue'=>$cardItem['question_id'], 
			'onChange'=>"" 
		)),
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"editAnswer", 'ajaxFolder'=>'edit', 'appTable'=>$appTable );
