...
W A R N I N G: Upload will ERASE all previous rates by selected annuity and current company!
	...
	$cardEditFormParams = array( 'cardItem'=>$cardItem, 'cardTmp'=>$cardTmp, 'rootPath'=>$rootPath, 'actionName'=>"createCompany", 'ajaxFolder'=>'create', 'appTable'=>$appTable );
	...
	$data['bodyContent'] .= "
		<div class='ipad-20' id='order_conteinter'>
			<h3 class='new-line'>Company create form</h3>";
