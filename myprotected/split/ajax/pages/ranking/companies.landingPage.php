<?php 
	...
	$itemsList = $zh->getCompanies($params);
	$totalItems = $zh->getCompanies($params,true);
	...
	$filter1_options = array( 'By ID'=>'M.id', 'By Name'=>'M.name', 'By Percent' => 'M.percent' );
	$filter2_options = array( 
								'Publish' => array( 'fieldName'=>'M.block', 'params' => array('Yes'=>'0', 'No'=>'1') ) 
							);
	$filter3_options = array( 
							'sort' => array( 'ID'=>'id', 'Name'=>'name', 'Percent' => 'percent' ),
	...
	$tableColumns = array(
						  ...
						  'Percent'				=>	array('type'=>'text',		'field'=>'percent'),
